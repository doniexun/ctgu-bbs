...
<div id="wrap">
	<div id="Top">
		<img alt="郑州轻工业学院" src="<%=request.getContextPath() %>/images/media.jpg" border="0">
		<label style="font-size: 30px; font-weight: bold;">三峡大学Java论坛</label>
		<div id="logRegist">
				<s:if test="#session.student!=null">
				<span id="po">
					<img alt="" src="<%=request.getContextPath() %>/upload/<s:property value="#session.student.photoPath"/>"
						style="float: right;width: 50px;height: 50px;" />
				</span>
				<h4>
					<s:a href="student_personalStuInfo.action"  action="student_student_personalStuInfo" method="student_personalStuInfo">
				...
				<s:else>
					...
					<h4>
						<s:a href="student_personalStuInfo.action" action="student_personalStuInfo" method="personalStuInfo">
							<s:property value="#session.student.nickName"/>
						</s:a>
					</h4>
				</s:else>
...
<div id="s_head">
	<div id="menu">
		<ul id="menu_left" style="">
			...
			<li class="menu_ge"></li>
			<li id="m_04">
				<s:a href="student_personalStuInfo"  action="student_personalStuInfo" method="personalStuInfo">个人资料</s:a>
			</li>
			<li class="menu_ge"></li>
			<li id="m_07">
			...
			<li class="menu_ge"></li>
			<li id="m_04">
				<s:a href="admin_personalAdminInfo"  action="admin_personalAdminInfo" method="personalAdminInfo">个人资料</s:a>
			</li>	
			...
			<li class="menu_ge"></li>
			<li id="m_07">
				<s:a href="board_loadRootBoards.action"  action="board_loadRootBoards" method="loadRootBoards">版块管理</s:a>
			</li>	
			<li class="menu_ge"></li>
			<li id="m_07">
				<a href="#">系统维护</a>
